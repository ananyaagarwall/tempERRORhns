  ...
  const propertySections = [
    {
      ...
      cards: [
        { id: "title-clearance", title: "Title Clearance & Due Diligence", subtitle: "Occupancy & Completion Certificate", location: "View in detail charts", description: "Comprehensive title verification and legal due diligence process ensuring clear property ownership...", documentTitle: "Legal Documents", documentItems: ["Title Deed", "Occupancy Certificate", "Completion Certificate", "RERA Registration"] },
        { id: "bank-loan", title: "Bank Loan Approval", subtitle: "Which banks and what amount", location: "Confidential info...", description: "Detailed information about approved banks and loan amounts for this property...", documentTitle: "Loan Documents", documentItems: ["Bank Approval Letter", "Interest Rate Details", "Eligibility Criteria", "Document Checklist"] }
      ]
    },
    {
      id: "lifestyle",
      ...
      cards: [
        { id: "neighbourhood", title: "Neighbourhood", subtitle: "View your neighbourhood details", location: "Information regarding society...", description: "Comprehensive neighborhood analysis including local amenities, community demographics, safety ratings...", documentTitle: "Neighborhood Guide", documentItems: ["Local Amenities", "Safety Ratings", "Community Profile", "Quality of Life Index"] },
        { id: "nearby-essentials", title: "Nearby Essentials", subtitle: "Hospitals, Schools...", location: "View plans, VIP passes...", description: "Essential services and facilities in the vicinity including healthcare, education...", documentTitle: "Essential Services", documentItems: ["Healthcare Facilities", "Educational Institutions", "Shopping Centers", "Transportation"] }
      ]
    },
    {
      id: "accounts-finance",
      ...
      cards: [
        { id: "senior-advisor-1", title: "Senior Advisor", subtitle: "Full Time • Remote available", location: "Available for you", description: "Expert financial advisory services for property investment and management...", documentTitle: "Financial Advisory", documentItems: ["Investment Analysis", "Tax Planning", "Portfolio Strategy", "Risk Assessment"] },
        { id: "senior-advisor-2", title: "Senior Advisor", subtitle: "Full Time • Remote available", location: "Available for you", description: "Comprehensive financial planning and advisory services tailored to real estate investments...", documentTitle: "Financial Planning", documentItems: ["Financial Planning", "Investment Strategy", "Risk Management", "Tax Optimization"] }
      ]
    }
  ];
