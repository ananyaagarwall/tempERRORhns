...
const CartPage = () => {
  ...
  const [activeTab, setActiveTab] = useState('all'); // 'all', 'listing', 'featured'
  ...
  // Separate properties by source (you can add a source field when adding to cart)
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <div className="flex gap-2 py-4">
              ...
              >
                <Home size={16} />
                Search Results ({listingProperties.length})
              </button>
              <button
            ...
            <div className="flex gap-3">
              {compareList.length >= 2 && (
                <button 
                  ...
                  className="bg-gradient-to-r from-purple-600 to-purple-700 text-gray px-5 py-2.5 rounded-lg hover:from-purple-700 hover:to-purple-800 transition shadow-md font-medium text-sm"
                >
              ...
              <button 
                ...
                className="bg-gradient-to-r from-blue-600 to-blue-700 text-gray px-5 py-2.5 rounded-lg hover:from-blue-700 hover:to-blue-800 transition shadow-md font-medium flex items-center gap-2 text-sm"
              >
                <Calculator size={18} />
                EMI Calculator
              </button>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-16 text-center">
                ...
                <h3 className="text-2xl font-semibold text-gray-900 mb-2">
                  {activeTab === 'all' 
                    ...
                    : activeTab === 'listing'
                    ? 'No properties from search results'
            ...
            <div className="lg:col-span-1 text-gray-900 ">
              <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-24">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <button onClick={() => setShowCalculator(false)} className="lg:hidden text-gray-500 hover:text-gray-700">
                    <X size={20} />
                  </button>
                </div>
