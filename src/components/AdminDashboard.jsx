...
const AdminDashboard = () => {
    ...
    useEffect(() => {
        ...
        // Fetch dashboard stats, builders, and users
        fetchDashboardStats();
        fetchBuilders();
        fetchUsers();
        fetchProjects();
    ...
    const fetchBuilders = async () => {
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(errorData.message || 'Failed to fetch builders');
            }
    ...
    const handleDelete = async (builderId) => {
        if (window.confirm('Are you sure you want to delete this builder?')) {
            try {
                const response = await fetch(`http://localhost:5000/api/builders/${builderId}`, {
                    method: 'DELETE',
                });
                if (!response.ok) {
    ...
    const handleUpdate = async (updatedBuilder) => {
        try {
            const response = await fetch(`http://localhost:5000/api/builders/${updatedBuilder.rera_id}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                },
                body: JSON.stringify(updatedBuilder),
            });
            if (!response.ok) {
                ...
                <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl shadow-lg overflow-hidden">
                    <div className="p-6">
                        <div className="flex items-center">
                            ...
                            <div className="ml-5 w-0 flex-1">
                                <dl>
                                    <dt className="text-sm font-medium text-white text-opacity-80 truncate">Total Builders</dt>
                                    <dd className="text-2xl font-bold text-white">{builders.length}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                            ...
                            modalType === 'view' ? (
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-gray-50 rounded-lg p-4">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <p className="mt-1 text-gray-900 font-medium">{selectedBuilder.company_name}</p>
                                            </div>
                                            <div>
                                                <label className="block text-sm font-medium text-gray-700">Brand Name</label>
                                                <p className="mt-1 text-gray-900 font-medium">{selectedBuilder.brand_name || 'N/A'}</p>
                                            </div>
                                            <div>
                                                <label className="block text-sm font-medium text-gray-700">Location</label>
                                                <p className="mt-1 text-gray-900 font-medium">{selectedBuilder.location}</p>
                                            </div>
                                            <div>
                                                <label className="block text-sm font-medium text-gray-700">RERA ID</label>
                                                <p className="mt-1 text-gray-900 font-medium">{selectedBuilder.rera_id}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-gray-50 rounded-lg p-4">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <p className="mt-1 text-gray-900 font-medium">{selectedBuilder.contact_email}</p>
                                            </div>
                                            <div>
                                                <label className="block text-sm font-medium text-gray-700">Phone</label>
                                                <p className="mt-1 text-gray-900 font-medium">{selectedBuilder.contact_number}</p>
                                            </div>
                                            <div>
                                                <label className="block text-sm font-medium text-gray-700">Website</label>
                                                <p className="mt-1 text-gray-900 font-medium">{selectedBuilder.website_url || 'N/A'}</p>
                                            </div>
                                            <div>
                                                <label className="block text-sm font-medium text-gray-700">Established Year</label>
                                                <p className="mt-1 text-gray-900 font-medium">{selectedBuilder.established_year || 'N/A'}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-gray-50 rounded-lg p-4">
                                        ...
                                        <p className="text-gray-900">{selectedBuilder.short_description || 'No description available'}</p>
                                    </div>
                                    ...
                                    <div className="bg-gray-50 rounded-lg p-4">
                                        ...
                                        <div className="flex items-center">
                                            <span className={`px-3 py-1 inline-flex text-sm leading-5 font-semibold rounded-full ${
                                                ...
                                                {selectedBuilder.verified ? 'Verified' : 'Pending'}
                                            </span>
                                            <button
                                ...
                                <form onSubmit={(e) => {
                                    ...
                                    <div className="space-y-6">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) => setSelectedBuilder({...selectedBuilder, company_name: e.target.value})}
                                                ...
                                                <div>
                                                    ...
                                                    <input
                                                        type="text"
                                                        value={selectedBuilder.brand_name || ''}
                                                        onChange={(e) => setSelectedBuilder({...selectedBuilder, brand_name: e.target.value})}
                                                        className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                                    />
                                                </div>
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) => setSelectedBuilder({...selectedBuilder, location: e.target.value})}
                                                        className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                                        required
                                                    />
                                                </div>
                                                <div>
                                                    ...
                                                    <input
                                                        type="number"
                                                        value={selectedBuilder.established_year || ''}
                                                        onChange={(e) => setSelectedBuilder({...selectedBuilder, established_year: e.target.value})}
                                                        className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                                    />
                                                </div>
                                            </div>
                                        ...
                                        <div className="bg-gray-50 rounded-lg p-4">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                <div>
                                                    ...
                                                    <input
                                                        type="email"
                                                        value={selectedBuilder.contact_email || ''}
                                                        onChange={(e) => setSelectedBuilder({...selectedBuilder, contact_email: e.target.value})}
                                                        className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                                        required
                                                    />
                                                </div>
                                                <div>
                                                    ...
                                                    <input
                                                        type="text"
                                                        value={selectedBuilder.contact_number || ''}
                                                        onChange={(e) => setSelectedBuilder({...selectedBuilder, contact_number: e.target.value})}
                                                        className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                                    />
                                                </div>
                                                <div>
                                                    ...
                                                    <input
                                                        type="url"
                                                        value={selectedBuilder.website_url || ''}
                                                        onChange={(e) => setSelectedBuilder({...selectedBuilder, website_url: e.target.value})}
                                                        className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                                    />
                                                </div>
                                            </div>
                                        ...
                                        <div className="bg-gray-50 rounded-lg p-4">
                                            <h4 className="text-lg font-medium text-gray-900 mb-4">Description</h4>
                                            <textarea
                                                value={selectedBuilder.short_description || ''}
                                                onChange={(e) => setSelectedBuilder({...selectedBuilder, short_description: e.target.value})}
                                                rows={3}
                                                className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                            />
                                        </div>
                                        ...
                                        <div className="bg-gray-50 rounded-lg p-4">
                                            ...
                                            <div className="flex items-center">
                                                <input
                                                    type="checkbox"
                                                    id="verified"
                                                    checked={selectedBuilder.verified || false}
                                                    onChange={(e) => setSelectedBuilder({...selectedBuilder, verified: e.target.checked})}
