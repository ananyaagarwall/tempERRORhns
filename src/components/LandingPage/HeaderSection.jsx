...
const HeaderSection = () => {
  ...
  return (
    <div className="header-section relative w-full h-screen text-white bg-cover bg-center overflow-hidden"
      style={{
        background: '#FFFFFF',
    ...
    >
        ...
        >
          ...
          {!isMobile && (
            <div className="desktop-nav" style={{ 
              ...
              <a href="#builders" className="nav-link" style={{ 
              ...
              >
                <FaRegUserCircle size={isTablet ? 18 : isLaptop ? 20 : 22} color="#fff" />
              </Link>
            </div>
          )}
        ...
        >
          ...
          <div className="action-cards-container" style={{ 
            ...
            <a 
              ...
              className={`action-card ${activeMenu === 'Buy' ? 'active' : ''}`}
            >
              <div>
                <div className="action-card-title">Buy</div>
            ...
            <a 
              ...
              className={`action-card ${activeMenu === 'Contact Us' ? 'active' : ''}`}
            >
              <div>
                <div className="action-card-title">Contact Us</div>
      ...
      {/* Main Section */}
      <main 
        className={`relative z-10 flex items-center justify-between max-w-[1400px] h-full mx-auto px-8 header-main ${isMobile ? 'mobile' : ''}`}
      >
        {/* Left: Hero Text */}
        <div
