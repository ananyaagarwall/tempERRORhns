...
const BudgetSection = () => (
  <section style={{ background: 'none', padding: '0', margin: '0', width: '100%', position: 'relative' }}>
    {/* Heading above the blue background */}
    <div style={{position: 'relative', zIndex: 3, width: '100%'}}>
      <h2 className="section-heading" style={{marginTop: 32}}>Have a Budget?</h2>
    ...
    <style>{`
      ...
      .budget-bg {
        ...
        z-index: 1;
        max-width: 1100px;
        box-shadow: 0 8px 32px 0 rgba(34,58,95,0.18), 0 2px 8px 0 rgba(34,58,95,0.10);
        margin-left: 60px;
      }
      ...
      .budget-option-row {
        ...
        background: #f9fafb;
        border-radius: 18px;
        box-shadow: 0 4px 18px rgba(34,58,95,0.10);
        display: flex;
        align-items: center;
        padding: 22px 28px;
        margin-bottom: 0;
      ...
      .budget-option-row:hover {
        box-shadow: 0 8px 32px #223A5F22;
      ...
      .budget-option-details {
        color: #6b7280;
        font-size: 1rem;
        margin-bottom: 2px;
      }
      
      .budget-option-locations {
        text-align: right;
        color: #6b7280;
        font-size: 1rem;
        min-width: 120px;
      ...
      /* Standard Tablet and Mobile fixes */
      ...
      @media (max-width: 600px) {
        ...
        /* Force image style on mobile too */
        .budget-option-img {
          width: 100% !important;
          max-width: 100% !important;
          ...
          border: 4px solid #3F4C7F !important;
          background: #fff;
          display: block;
        }
        .budget-option-info, .budget-option-locations {
          width: 100%;
          box-sizing: border-box;
        }
      }
