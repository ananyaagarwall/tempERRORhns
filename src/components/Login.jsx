...
const Login = () => {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50">
            ...
            <div className="relative w-[400px] transform transition-all duration-300 hover:scale-[1.02]">
                <div className="bg-white/10 backdrop-blur-xl p-6 rounded-2xl shadow-2xl border border-white/20">
                    ...
                    <h2 className="text-2xl font-bold mb-4 text-center mt-4 text-white">Login</h2>
                    {error && (
